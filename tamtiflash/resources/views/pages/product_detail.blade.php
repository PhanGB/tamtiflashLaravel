                            ...
                            <div class="product-detail__content-info">
                                <div class="row">
                                    <div class="col l-6 m-6 c-12 product-detail__content-image">
                                        <img src="public/images/products/banhkemtrungmuoi.jpg" alt="product" class="product-detail__content-image-img">
                                    </div>
                                    <div class="col l-6 m-6 c-12 product-detail__content-title">
                                        <div class="product-detail__content-name">Bánh kem trứng muối</div>
                                        ...
                                        <div class="product-detail__content-price">
                                            ...
                                            <span class="product-detail__content-price-current">65.000đ</span>
                                        </div>
                            ...
                            <div class="row">
                                <div class=" l-6 m-12 c-12 product-detail__info-shop">
                                    <div class="product-detail__info-image">
                                        <img src="public/images/shops/circle.png" alt="Ảnh cửa hàng" class="product-detail__info-image-img">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col l-3 m-6 c-6">
                                    <div class="product-related__item">
                                        <img src="public/images/products/banhkemtrungmuoi.jpg" alt="Combo Cơm cháy + Trà đường là đà" class="product-related__item-img">
                                ...
                                <div class="col l-3 m-6 c-6">
                                    <div class="product-related__item">
                                        <img src="public/images/products/banhkemtrungmuoi.jpg" alt="Bánh tráng cuốn + Trà chanh" class="product-related__item-img">
                                ...
                                <div class="col l-3 m-6 c-6">
                                    <div class="product-related__item">
                                        <img src="public/images/products/banhkemtrungmuoi.jpg" alt="Bánh tráng cuốn" class="product-related__item-img">
                                        <h4 class="product-related__item-name"><a href="">Bánh tráng cuốn</a></h4>
                                        <p class="product-related__item-cate">Quán Ngũ Long | 100 lượt mua</p>
                                        <p class="product-related__item-price">25.000đ <span>30.000đ</span></p>
                                        <button class="product-related__item-btn">Thêm vào giỏ</button>
