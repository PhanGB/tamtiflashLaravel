    ...
    <div class="bg-light rounded h-100 p-4">
        ...
        <form action="{{ route('admin.add') }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 col-form-label">
                    <input type="text" class="form-control" placeholder="Nhập mô tả ngắn" name="short_description" required>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-9 col-form-label">
                    <div class="d-flex align-items-center">
                        <input type="number" class="form-control" min="0" max="23"
                            style="width: 60px;" name="time_open" required><span class="me-2">h</span>
                        <span class="me-2">-</span>
                        <input type="number" class="form-control" min="0" max="23"
                            style="width: 60px;" name="time_close" required><span>h</span>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 col-form-label">
                    <input type="text" class="form-control" placeholder="Nhập link địa chỉ cửa hàng" name="address" required >
                </div>
            </div>
            <div class="row mb-3">
