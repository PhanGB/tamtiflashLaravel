    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="{{ url('/admin/products') }}" class="nav-item nav-link"><i class="fa fa-utensils me-2"></i>Sản phẩm</a>
                <a href="{{ url('/admin/category') }}" class="nav-item nav-link"><i class="fa fa-list me-2"></i>Danh mục</a>
