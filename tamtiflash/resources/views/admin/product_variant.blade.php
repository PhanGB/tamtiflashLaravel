...
@section ('content')
 ...
 <div class="container-fluid pt-4 px-4">
    <div class="bg-light rounded h-100 p-4">
        ...
        <a class="btn btn-primary rounded-pill m-2" href="{{ route('product.variant_add', ['id' => $product->id]) }}">Thêm biến thể</a>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('product.variant_edit', ['id' => $item->id]) }}">Sửa</a></td>
                    </tr>
